...
\begin{itemize}
  \item Por incompatibilidades de hardware, se usó \texttt{SoftwareSerial.h} para reemplazar \texttt{Serial1} en el Arduino UNO.
...
Durante la fase de inicialización, el dispositivo detecta automáticamente la presencia de los sensores I\textsuperscript{2}C y habilita por defecto las mediciones periódicas (1~segundo) para aquellos sensores activos.
